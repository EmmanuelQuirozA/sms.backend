...
public class SchoolController {
    ...
    public ResponseEntity<?> getSchoolsList(@RequestHeader("Authorization") String authHeader,
        ...
        try {
            ...
            List<SchoolsList> schools = schoolService.getSchoolsList(tokenSchoolId, school_id, lang, status_filter);
    ...
    @PreAuthorize("hasAnyRole('ADMIN')")
    @PutMapping("/admin/update/{school_id}")
    ...
    @PreAuthorize("hasAnyRole('ADMIN')")
    @PostMapping("/admin/update/{school_id}/status")
