...
public class StudentListResponse {
    ...
    private Boolean role_enabled;
    private Boolean school_enabled;
    private Boolean group_enabled;
    private String birth_date_formated;
    ...
    public Boolean getSchool_enabled() {
        return school_enabled;
    }
    public void setSchool_enabled(Boolean school_enabled) {
        this.school_enabled = school_enabled;
    }
    public Boolean getGroup_enabled() {
        return group_enabled;
    }
    public void setGroup_enabled(Boolean group_enabled) {
        this.group_enabled = group_enabled;
    }
    public String getBirth_date_formated() {
        return birth_date_formated;
    }
    public void setBirth_date_formated(String birth_date_formated) {
        this.birth_date_formated = birth_date_formated;
    }
